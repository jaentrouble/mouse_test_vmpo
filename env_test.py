...
writer = cv2.VideoWriter('unitytest.mp4',fourcc,20, (80,80))
writer_ren = cv2.VideoWriter('unitytest_ren.mp4',fourcc,20, (192,192))
...
for _ in trange(3000):
    ...
    o, r, d, i = env.step(np.array([1.0,direction-2]))
